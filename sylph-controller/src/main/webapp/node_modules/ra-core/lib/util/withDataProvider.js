    ...
    dataProvider: function (type, resource, payload, meta) {
        ...
        return new Promise(function (resolve, reject) {
            var action = {
                type: 'CUSTOM_FETCH',
                payload: payload,
                meta: __assign({}, meta, { resource: resource, fetch: type, onSuccess: __assign({}, get_1.default(meta, 'onSuccess', {}), { callback: function (_a) {
                            var response = _a.payload;
                            return resolve(response);
                        } }), onFailure: __assign({}, get_1.default(meta, 'onFailure', {}), { callback: function (_a) {
                            var error = _a.error;
