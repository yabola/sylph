...
public class HbaseHelper
{
    ...
    private String defaultFamily = "0";
    ...
    public HbaseHelper(String tableName, String zk, String zkNodeParent)
            throws IOException
    {
     ...
     */
    public Boolean existGet(Get get)
            throws IOException
    {
     ...
     * @return existence returns true, otherwise returns false.
     */
    public Boolean[] existGet(List<Get> gets)
            throws IOException
    {
    ...
    {
        addColumn(defaultFamily, qualifier, columnValue, put);
    }
     ...
     **/
    public void store(List<Put> puts)
            throws IOException
    {
        getTable().put(puts);
    }
     ...
     * @param value .
     **/
    public void store(byte[] family, byte[] qualifier, Long timeStamp, byte[] rowkey, byte[] value)
            throws IOException
    {
    ...
    public void store(byte[] family, byte[] qualifier, byte[] rowkey, byte[] value)
            throws IOException
    {
